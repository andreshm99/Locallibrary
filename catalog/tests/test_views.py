...
class LoanedBookInstancesByUserListViewTest(TestCase):
    ...
    def setUp(self):
        ...
        for book_copy in range(number_of_book_copies):
            ...
            BookInstance.objects.create(
                book=test_book, imprint='Unlikely Imprint, 2016', due_back=return_date, borrower=the_borrower, status=status)
    ...
    def test_only_borrowed_books_in_list(self):
        ...
        # Check that we got a response "success"
        self.assertEqual(resp.status_code, 200)
        # Check that initially we don't have
        # any books in list (none on loan)
...
class RenewBookInstancesViewTest(TestCase):
    ...
    def test_form_invalid_renewal_date_future(self):
        ...
        resp = self.client.post(
            reverse('renew-book-librarian', kwargs={'pk': self.test_bookinstance1.pk, }), {'renewal_date': invalid_date_in_future})
        self.assertEqual(resp.status_code, 200)
        self.assertFormError(
            resp, 'form', 'renewal_date', 'Invalid date - renewal more than 4 weeks ahead')
...
class AuthorCreateViewTest(TestCase):
    ...
    def setUp(self):
        test_user1 = User.objects.create_user(
            username='testuser1', password='profesordb')
        test_user2 = User.objects.create_user(
            username='testuser2', password='alumnodb')
